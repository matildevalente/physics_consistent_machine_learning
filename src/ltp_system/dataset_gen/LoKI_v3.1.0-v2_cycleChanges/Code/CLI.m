...
classdef CLI < handle
  ...
  methods (Access = public)
    ...
    function cli = CLI(setup)
      ...
      cli.logStr{end+1} = '*                                                                            *';
      cli.logStr{end+1} = '*                   _        _  _____       ____  _   __                     *'; 
      cli.logStr{end+1} = '*                  | |   ___| |/ /_ _| __ _|__ / / | /  \                    *';
      cli.logStr{end+1} = '*                  | |__/ _ \ '' < | |  \ V /|_ \_| || () |                   *';
      cli.logStr{end+1} = '*                  |____\___/_|\_\___|  \_/|___(_)_(_)__/                    *';
...
%       cli.logStr{end+1} = '*              |____\___/_|\_\___|  |___/  \_//___(_)___(_)__/               *';
    ...
    function configure(cli)
      ...
      if cli.setup.enableChemistry
        ...
        % add listener to update the CLI when a new iteration of the electron density cycle is found
        addlistener(cli.setup.chemistry, 'newElecDensityCycleIteration', @cli.newElecDensityCycleIteration);        
  ...
  methods (Access = private)
    ...
    function newElecDensityCycleIteration(cli, chemistry, ~)

      str = sprintf('\t- New electron density cycle iteration (%d): relative error = %e', ...
