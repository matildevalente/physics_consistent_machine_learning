function [rateCoeff, dependent] = wallReaction(~, ~, ~, reactionArray, reactionID, stateArray, workCond, ~, ...
  rateCoeffParams)
  % wallReaction evaluates the transport rate coefficient of a particular species interacting with a wall, assuming a
  % flux reaching the wall (neglecting diffusion time) and a certain wall recombination/deactivation probability
  % 
