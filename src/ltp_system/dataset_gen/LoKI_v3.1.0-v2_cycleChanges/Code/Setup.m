      ...
      if isfield(setupInfo, 'chemistry')
        ...
        elseif setupInfo.chemistry.isOn
          ...
          elseif setupInfo.chemistry.thermalModel.isOn
            if (workCondStruct.chamberRadius == 0 )
            ...
            elseif ~isfield(setupInfo, 'electronKinetics') || ~setupInfo.electronKinetics.isOn
              error([str1 'Thermal model cannot be activated ' ...
                'without antivating the electronKinetics module.' str2],1);
          ...
          if ~isfield(setupInfo.output, 'dataFiles')
            ...
            if isfield(setupInfo, 'electronKinetics') && setupInfo.electronKinetics.isOn && ...
              ...
              if setupInfo.chemistry.thermalModel.isOn
                possibleDataFiles = [possibleDataFiles 'finalThermalBalance'];
              end
              possibleDataFiles = [possibleDataFiles 'chemSolutionTime'];
            elseif isfield(setupInfo, 'electronKinetics') && setupInfo.electronKinetics.isOn
              possibleDataFiles = [possibleDataFiles 'eedf' 'swarmParameters' 'rateCoefficients' 'powerBalance' ...
                'lookUpTable'];
            elseif isfield(setupInfo, 'chemistry') && setupInfo.chemistry.isOn
              possibleDataFiles = [possibleDataFiles 'rateCoefficients' 'finalDensities' 'finalTemperatures' ...
