...
def get_trained_nn(options, config, data_preprocessing_info, idx_dataset, idx_sample, train_data, val_loader):
    ...
    checkpoint_dir = os.path.join(options['checkpoints_dir'], f'dataset_{idx_dataset}_sample_{idx_sample}') #os.path.join('output', 'ltp_system', 'checkpoints', 'different_datasets', f'dataset_{idx_dataset}_sample_{idx_sample}')
